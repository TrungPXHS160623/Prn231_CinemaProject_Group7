        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Concession>(entity =>
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK__Concessi__B40CC6CDB75FF3EF");
            ...
            modelBuilder.Entity<ConcessionsCategory>(entity =>
            {
                entity.HasKey(e => e.CategoryId)
                    .HasName("PK__Concessi__19093A0B90F96646");
            ...
            {
                entity.HasIndex(e => e.Email, "UQ__Customer__A9D1053453930590")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Email, "UQ__Employee__A9D10534E3935870")
                    .IsUnique();
            ...
            modelBuilder.Entity<Movie>(entity =>
            {
                ...
                entity.HasMany(d => d.Categories)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MovieId", "CategoryId").HasName("PK__Movie_Ca__EA4207BA2F0F7753");
            ...
            modelBuilder.Entity<MovieReview>(entity =>
            {
                entity.HasKey(e => e.ReviewId)
                    .HasName("PK__MovieRev__74BC79CED68C8177");
            ...
            modelBuilder.Entity<OrderStatus>(entity =>
            {
                entity.HasKey(e => e.StatusId)
                    .HasName("PK__Order_St__C8EE2063FDCCEA75");
